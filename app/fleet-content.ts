...
import { september2ResearchPosts } from './article-research-sep2-2026';
import { september3ResearchPosts } from './article-research-sep3-2026';

import { september4ResearchPosts } from './article-research-sep4-2026';
import { september7ResearchPosts } from './article-research-sep7-2026';
import { september8ResearchPosts } from './article-research-sep8-2026';
import { september9ResearchPosts } from './article-research-sep9-2026';
import { september10ResearchPosts } from './article-research-sep10-2026';
import { september11ResearchPosts } from './article-research-sep11-2026';
import { september14ResearchPosts } from './article-research-sep14-2026';
import { september18ResearchPosts } from './article-research-sep18-2026';
import { september22ResearchPosts } from './article-research-sep22-2026';
...
const publishingResearchConfigs: readonly PublishingResearchConfig[] = [
  ...
  { slug: 'operations-assistant-daily-workflow', primaryKeyword: 'operations assistant daily workflow', title: 'Operations assistant daily workflows: evidence for a reliable handoff', metaTitle: 'Operations assistant daily workflows: evidence guide', excerpt: 'A source-led guide to designing an operations assistant workday around queues, exception rules, ownership, and a reviewable daily handoff.', focus: 'an operations assistant daily workflow', audience: 'an operations owner', serviceHref: '/services/operations-assistant-staffing', serviceLinkTitle: 'Plan operations assistant staffing', serviceLinkDescription: 'Use the workflow to set a Philippines-based operations role around clear queues and stop rules. The operations owner keeps process changes, spending, access, and exception decisions.', revision: '2026-09-25-operations-workflow-handoff-v2', published: '2026-08-09', updated: '2026-09-25' },
...
const makePublishingResearchPost = (config: PublishingResearchConfig): ResearchPost => ({
  ...
  related: [
    ...(config.serviceHref && config.serviceLinkTitle && config.serviceLinkDescription ? [{ title: config.serviceLinkTitle, href: config.serviceHref, description: config.serviceLinkDescription }] : []),
...
researchPosts = [...researchPosts, ...publishingResearchConfigs.map(makePublishingResearchPost)]
  ...
  .concat(august23ResearchPosts)
  .concat(august31ResearchPosts)
  .concat(september2ResearchPosts)
  .concat(september4ResearchPosts)
  .concat(september7ResearchPosts)
  .concat(september8ResearchPosts)
  .concat(september9ResearchPosts)
  .concat(september10ResearchPosts)
  .concat(september11ResearchPosts)
  .concat(september14ResearchPosts)
  .concat(september18ResearchPosts)
  .concat(september22ResearchPosts)
