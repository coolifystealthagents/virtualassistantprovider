...
const publishingResearchConfigs: readonly PublishingResearchConfig[] = [
  ...
  { slug: 'research-owner-handoff-note', primaryKeyword: 'research owner handoff note', title: 'Research owner handoff notes: make the next decision clear', metaTitle: 'Research owner handoff notes', excerpt: 'An owner handoff note states what was checked, what remains open, and who must decide before a research article moves forward.', focus: 'an owner handoff note', audience: 'a publishing owner', revision: '2026-08-10-owner-handoff-v1' },
  { slug: 'research-source-access-log', primaryKeyword: 'research source access log', title: 'Research source access logs: preserve the evidence trail', metaTitle: 'Research source access logs', excerpt: 'A source access log records when a page or dataset was checked and gives the next reviewer enough context to repeat the lookup.', focus: 'a source access log', audience: 'a research editor', revision: '2026-08-10-source-access-v1' },
  { slug: 'research-claim-source-map', primaryKeyword: 'research claim source map', title: 'Research claim-to-source maps: keep support visible', metaTitle: 'Research claim-to-source maps', excerpt: 'A claim-to-source map links each material sentence to the evidence that supports it and shows where the source stops.', focus: 'a claim-to-source map', audience: 'a fact checker', revision: '2026-08-10-claim-source-map-v1' },
  { slug: 'research-evidence-table-review', primaryKeyword: 'research evidence table review', title: 'Research evidence-table reviews: test every row', metaTitle: 'Research evidence-table reviews', excerpt: 'A row-by-row review checks that each finding, buyer use, limit, and citation still answer the article’s question.', focus: 'an evidence-table review', audience: 'a content editor', revision: '2026-08-10-evidence-table-review-v1' },
  { slug: 'research-reading-level-check', primaryKeyword: 'research article reading level check', title: 'Research reading-level checks: explain evidence plainly', metaTitle: 'Research reading-level checks', excerpt: 'A reading-level pass removes avoidable jargon while keeping definitions, uncertainty, and source limits intact.', focus: 'a reading-level check', audience: 'a research editor', revision: '2026-08-10-reading-level-v1' },
  { slug: 'research-external-link-health-check', primaryKeyword: 'research external link health check', title: 'Research external-link health checks: keep citations usable', metaTitle: 'Research external-link health checks', excerpt: 'An external-link review checks that cited pages resolve, belong to the named source, and still support the nearby claim.', focus: 'an external-link health check', audience: 'a web editor', revision: '2026-08-10-external-link-health-v1' },
  { slug: 'research-faq-answerability-check', primaryKeyword: 'research FAQ answerability check', title: 'Research FAQ answerability checks: answer only what the evidence supports', metaTitle: 'Research FAQ answerability checks', excerpt: 'An FAQ review tests whether each answer is direct, supported, and narrow enough to avoid turning a general source into a promise.', focus: 'an FAQ answerability check', audience: 'a research editor', revision: '2026-08-10-faq-answerability-v1' },
  { slug: 'research-date-stamp-review', primaryKeyword: 'research article date stamp review', title: 'Research date-stamp reviews: separate published from accessed', metaTitle: 'Research date-stamp reviews', excerpt: 'A date-stamp review distinguishes publication, update, data, and access dates so readers can judge how current a finding is.', focus: 'a date-stamp review', audience: 'a fact checker', revision: '2026-08-10-date-stamp-v1' },
  { slug: 'research-batch-scope-review', primaryKeyword: 'research batch scope review', title: 'Research batch-scope reviews: publish a coherent set', metaTitle: 'Research batch-scope reviews', excerpt: 'A batch-scope review checks that the day’s articles belong to the Research family, answer distinct questions, and share a clear validation record.', focus: 'a batch-scope review', audience: 'a publishing owner', revision: '2026-08-10-batch-scope-v1' },
  { slug: 'research-source-authority-check', primaryKeyword: 'research source authority check', title: 'Research source-authority checks: match the source to the claim', metaTitle: 'Research source-authority checks', excerpt: 'A source-authority check asks whether the publisher has the standing, method, and direct relationship needed for the claim being made.', focus: 'a source-authority check', audience: 'a research editor', revision: '2026-08-10-source-authority-v1' },
];
...
const makePublishingResearchPost = (config: PublishingResearchConfig): ResearchPost => ({
  ...
  published: config.revision.startsWith('2026-08-10') ? '2026-08-10' : config.revision.startsWith('2026-08-08') ? '2026-08-08' : '2026-08-04',
  updated: config.revision.startsWith('2026-08-10') ? '2026-08-10' : config.revision.startsWith('2026-08-08') ? '2026-08-08' : '2026-08-04',
  readingMinutes: 8,
